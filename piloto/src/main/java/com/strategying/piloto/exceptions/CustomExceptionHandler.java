package com.strategying.piloto.exceptions;
...
//                // Aqui você poderia por exemploinstanciar as classes StringWriter e PrintWriter
                ...
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage
                    (FacesMessage.SEVERITY_ERROR, "Error inseperado en el sistema.", ""));
 
                // Tranquiliza o usuário para que ele continue usando o sistema
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage
                    (FacesMessage.SEVERITY_INFO, "Puede seguir usando el sistema con normalidad!", ""));
