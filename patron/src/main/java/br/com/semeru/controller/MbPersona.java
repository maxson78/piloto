...
public class MbPersona implements Serializable {
    ...
    private void insertPessoa() {
        ...
        if (pessoa.getSenha() == null ? confereSenha == null : pessoa.getSenha().equals(ConverterSHA1.cipher(confereSenha))) {
            ...
            FacesContext.getCurrentInstance().addMessage(null,
                    new FacesMessage(FacesMessage.SEVERITY_INFO, "Grabado satisfactoriamenete", ""));
        } else {
            FacesContext.getCurrentInstance().addMessage(null,
                    new FacesMessage(FacesMessage.SEVERITY_INFO, "Los campos contraseña no estan confirmados", ""));
        }
    }
    ...
    private void updatePessoa() {
        ...
        FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage(FacesMessage.SEVERITY_INFO, "Actualizada la persona", ""));
    }
    ...
    public String deletePessoa() {
        ...
        FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage(FacesMessage.SEVERITY_INFO, "Resgitro persona eliminada", ""));
        return null;
    }
